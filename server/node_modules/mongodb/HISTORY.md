...
* **distinct:** return full productResponse if `full` option was specified ([95a7d05](https://github.com/mongodb/node-mongodb-native/commit/95a7d05))
...
* **cursor:** close readable on `null` productResponse for dead cursor ([6aca2c5](https://github.com/mongodb/node-mongodb-native/commit/6aca2c5))
...
1.4.5 2014-05-21
----------------
* Added fullResult flag to insert/update/remove which will pass raw result document back. Document contents will vary depending on the server version the driver is talking to. No attempt is made to coerce a joint productResponse.
...
* Drivers should check the query failure bit even on getmore productResponse (Issue #1018)
